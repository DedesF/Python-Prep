class Calcular:
    ...
    def convertirlist(lista, origen, destino):
        if (type(lista) != list):
            print('Debe ingresar una lista con número enteros')
            
        elif (origen != 'celsius') and (origen != 'farenheit') and (origen != 'kelvin'):
            print('Los paramentros Origen y destino deben ser celsius, farenheit o kelvin')
        
        elif (destino != 'celsius') and (destino != 'farenheit') and (destino != 'kelvin'):
            print('Los parametros Origen y destino deben ser celsius, farenheit o kelvin')
        
        elif (type(lista) == list):
            for valor in lista:
                if (type(valor) != int):
                    print('Verifique que la lista sólo contiene números enteros')
